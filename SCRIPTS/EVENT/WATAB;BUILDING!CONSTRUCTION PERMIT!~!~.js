...
try{
	...
	if (wfTask == "Begin Reviews" && matches(AInfo['Type of Permit'], "Construction Trailer", "Demo - Building","Addition","Foundation", "New Commercial","New Duplex/Triplex","New Mobile Home", "New Multi-Family Dwelling","New SF Detached","New Townhome","Pool - In Ground","Portable Storage", "Site Work Only","Structure Move") && !isTaskActive("Land Resources Review")) {
		showMessage = true;
