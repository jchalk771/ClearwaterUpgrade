/*------------------------------------------------------------------------------------------------------/
| Program: ENG_BILLING_STMT.js  Trigger: Batch    Client : Clearwater, FL
|
| Version 1.0 - Base Version. 6/14/2013 - Lydia Moreda - City of Clearwater
|
| Adding a Notes comment to all ENG cases receiving a billing statment for the Idlewild Sewer project.
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
var bizDomScriptResult = aa.bizDomain.getBizDomain("ENG_BILLING_STMT");
...
if (bizDomScriptResult.getSuccess())
{
	...
	do
	{
		...
		if( entry )
		{
			doENG_BILLING_STMT( entry.getDispBizdomainValue() );
		}
	}
