/*------------------------------------------------------------------------------------------------------/
| Program: MIS_RENEWAL_NOTICE.js  Trigger: Batch    Client : Clearwater, FL
|
| Version 1.0 - Base Version. 6/12/2013 - Lydia Moreda - City of Clearwater
|
| Adding a Notes comment to all cases (doggie dining, low speed permits) that are mailed a Renewal notice
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
var bizDomScriptResult = aa.bizDomain.getBizDomain("MIS_RENEWAL_NOTICE");
...
if (bizDomScriptResult.getSuccess())
{
	...
	do
	{
		...
		if( entry )
		{
			doMIS_RenewalNotice( entry.getDispBizdomainValue() );
		}
	}
...
function doMIS_RenewalNotice( altid )
{
	...
	updateTask("Final Inspection", "Notes", "MIS Renewal Notice Sent", "MIS Renewal Notice Sent");
}
