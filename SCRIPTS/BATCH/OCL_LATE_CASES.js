/*------------------------------------------------------------------------------------------------------/
| Program: OCL_Late_Cases.js  Trigger: Batch    Client : Clearwater, FL
|
| Version 1.0 - Base Version. 9/29/2010 - Nicholas Dorrough - City of Clearwater
|
| BTR Renewal Batch that is used to add a late fee to outstanding BTR cases
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
if (bizDomScriptResult.getSuccess())
{
	...
	do
	{
		...
		if( entry )
		{
			doBTRLateFee( entry.getDispBizdomainValue() );
		}
	}
...
function doBTRLateFee( altid )
{
	...
	// Assess the fee
	logDebug("Adding late fee of type " + fee);
	addFee(fee,"T_BTR","FINAL",1, "Y", capId);
}