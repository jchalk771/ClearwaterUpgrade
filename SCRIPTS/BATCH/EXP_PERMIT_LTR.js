/*------------------------------------------------------------------------------------------------------/
| Program: EXPIRATION_REMINDER_SENT.js  Trigger: Batch    Client : Clearwater, FL
|
| Version 1.0 - Base Version. 7/20/2010 - Nicholas Dorrough - City of Clearwater
|
| Adding a Notes comment to cases whose permit is about to expire.
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
var bizDomScriptResult = aa.bizDomain.getBizDomain("EXPIRATION_REMINDER_LETTER");
...
if (bizDomScriptResult.getSuccess())
{
	...
	do
	{
		...
		if( entry )
		{
			doExpLetter( entry.getDispBizdomainValue() );
		}
	}
...
function doExpLetter( altid )
{
	...
	updateTask("Active Permit", "Notes", "Expiration Reminder Sent to Owner and Contractor.", "Expiration Reminder Sent to Owner and Contractor.");
}
