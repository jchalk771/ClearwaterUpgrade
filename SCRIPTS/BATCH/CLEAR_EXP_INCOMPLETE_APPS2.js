batchJobName = "CLEAR_EXP_INCOMPLETE_APPS"; // Please replace batchJobName value with the actual Batch Job Name.
batchJobDesc = "CLEAR_EXP_INCOMPLETE_APPS"; // Please replace batchJobDesc value with the actual Batch Job Description.
batchJobResult = "CLEAR_EXP_INCOMPLETE_APPS"; // Please replace batchJobResult value with the actual Batch Job Result.
