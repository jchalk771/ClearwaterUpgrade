/*------------------------------------------------------------------------------------------------------/
| Program: LIEN_LETTER_ISSUED.js  Trigger: Batch    Client : Clearwater, FL
|
...
var bizDomScriptResult = aa.bizDomain.getBizDomain("LIEN_LETTERS_ISSUED");
...
if (bizDomScriptResult.getSuccess())
{
	...
	do
	{
		...
		if( entry )
		{
			doLienLetter( entry.getDispBizdomainValue() );
		}
	}
...
function doLienLetter( altid )
{
	...
	updateTask("Active Permit", "Notes", "Lien Letter Sent", "Lien Letter Sent");
}
