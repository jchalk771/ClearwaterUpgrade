/*------------------------------------------------------------------------------------------------------/
| Program : ApplicationConditionAddBeforeV3.js
| Event   : ApplicationConditionAddBefore
|
...
| Action# : N/A
|
| Notes   : New Master Script 7.5.2017 jchalk, Accela
|
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
/------------------------------------------------------------------------------------------------------*/
var conditionApplyDate = aa.env.getValue("ConditionApplyDate");
logDebug("conditionApplyDate = " + conditionApplyDate);
var conditionComment = aa.env.getValue("ConditionComment");
logDebug("conditionComment = " + conditionComment);
var conditionEffectiveDate = aa.env.getValue("ConditionEffectiveDate");
logDebug("conditionEffectiveDate = " + conditionEffectiveDate);
var conditionExpirationDate = aa.env.getValue("ConditionExpirationDate");
logDebug("conditionExpirationDate = " + conditionExpirationDate);
var conditionId = aa.env.getValue("ConditionId");
logDebug("conditionId = " + conditionId);
var conditionSeverity = aa.env.getValue("ConditionSeverity");
logDebug("conditionSeverity = " + conditionSeverity);
